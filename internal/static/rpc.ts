...
const mapDataCheckers: ((data: Record<string, any>) => void)[] = [],
	...
	return data;
      ...
      checksWall: checkers = [[checkObject, ""], [checkUint, "id"], [checkUint, "x1"], [checkUint, "y1"], [checkUint, "x2"], [checkUint, "y2"], [checkColour, "colour"]],
