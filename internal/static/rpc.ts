	...
	return RPC(url, 1.1).then(arpc => {
		const argProcessors: Record<string, (args: IArguments, names: string[]) => any> = {
			...
			"": [
				...
				["newMusicPack",         "music.new",             "!",                             checkString,     "waitMusicPackAdd", "*"],
				["renameMusicPack",      "music.rename",         ["from", "to"],                   checkString,     "waitMusicPackRename", "*"],
				["removeMusicPack",      "music.remove",          "!",                             returnVoid,      "waitMusicPackRemove", ""],
				["copyMusicPack",        "music.copy",           ["from", "to"],                   checkString,     "waitMusicPackCopy", "to"],
