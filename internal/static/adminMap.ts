...
import {SVGToken, SVGShape, SVGDrawing, addLayer, addLayerFolder, getLayer, getParentLayer, isSVGFolder, isSVGLayer, removeLayer, renameLayer, setLayerVisibility, moveLayer, setMapDetails, setLightColour, mapView, isTokenImage, isTokenDrawing, updateLight, normaliseWall, splitAfterLastSlash} from './map.js';
...
import {characterData, deselectToken, globals, mapLoadReceive, mapLoadedSend, tokenSelected, SQRT3, queue, labels} from './shared.js';
