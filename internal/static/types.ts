...
export type RPC = {
	...
	addLayerFolder:  (path: Int[], name: string)             => Promise<void>;
	renameLayer:     (id: Int[], name: string)               => Promise<void>;
	moveLayer:       (from: Int[], to: Int[], position: Int) => Promise<void>;
	showLayer:       (path: Int[])                           => Promise<void>;
	hideLayer:       (path: Int[])                           => Promise<void>;
	addMask:         (path: Int[], mask: Int)                => Promise<void>;
	removeMask:      (path: Int[])                           => Promise<void>;
	removeLayer:     (path: Int[])                           => Promise<void>;
	addToken:        (path: Int[], token: Token)             => Promise<void>;
	removeToken:     (path: Int[])                           => Promise<void>;
	moveToken:       (path: Int[], x: Int, y: Int)           => Promise<void>;
	resizeToken:     (path: Int[], width: Int, height: Int)  => Promise<void>;
	rotateToken:     (path: Int[], rotation: Int)            => Promise<void>;
	flipToken:       (path: Int[], flip: boolean)            => Promise<void>;
	flopToken:       (path: Int[], flop: boolean)            => Promise<void>;
	setTokenPattern: (path: Int[])                           => Promise<void>;
	setTokenImage:   (path: Int[])                           => Promise<void>;
	setTokenSource:  (path: Int[], source: string)           => Promise<void>;
	setTokenLayer:   (path: Int[], layer: Int[])             => Promise<void>;
	setTokenTop:     (path: Int[])                           => Promise<void>;
	setTokenBottom:  (path: Int[])                           => Promise<void>;
