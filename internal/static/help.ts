...
const settingsOutline = path({"stroke": "currentColor", "fill": "none"}),
	...
	return svg({"id": helpDemo, "viewBox": "0 0 500 300"}, [
		...
		g({"transform": "translate(500, 0)"}, [
			...
			settingsText,
			animateTransform({"attributeName": "transform", "type": "translate", "from": "500 0", "to": "250 0", "dur": "1s", "fill": "freeze", "begin": `${helpPanelOpenClick1}.end 0.1s`}),
		...
		g({"stroke": "#000", "fill": "#fff"}, [
			...
			g({"stroke-width": 0.5}, [
				rect({"x": 1, "y": 18, "width": 3, "height": 10, "rx": 1}, [
					startMapDragDemo,
					animate({"attributeName": "fill", "values": "#fff", "fill": "freeze", "dur": "1s", "begin": `${helpMapDragMouse}.end`, "onendEvent": startNextDemo}),
...
export default () => {
	if (!help.parentNode) {
		amendNode(shell, clearNode(help, div({"id": helpID}, [
			h1(lang["HELP"]),
			createDemo(),
			div({"id": helpDemos}, [
				labels(mapDrag, lang["HELP_MAP_DRAG"]),
				labels(mapZoom, lang["HELP_MAP_ZOOM"]),
				labels(mapScroll, lang["HELP_MAP_SCROLL"]),
