...
import {createSVG, animate, animateMotion, circle, defs, ellipse, feColorMatrix, filter, g, line, linearGradient, mask, mpath, path, pattern, polygon, radialGradient, rect, stop, svg, symbol, text, use} from '../lib/svg.js';
...
import symbols, {addSymbol, remove, rename, userVisible} from '../symbols.js';
...
createSVG(symbols, filter({"id": "saturate-5e"}, feColorMatrix({"type": "saturate", "values": 0})));
