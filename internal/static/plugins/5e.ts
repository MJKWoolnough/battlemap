...
amendNode(symbols, [
	...
	symbol({"id": "5e-CONDITION_DYING", "viewBox": "0 0 100 54"}, [defs(path({"id": "5e-dying", "d": "M0,32 h20 l3,-10 l6,30 l10,-50 l8,40 l4,-10 l4,15 l6,-25 l3,10 h36", "fill": "none", "stroke-linejoin": "round", "stroke-dasharray": "150 102"}, dyingAnimate)), use({"href": "#5e-dying", "stroke": "#000", "stroke-width": 4}), use({"href": "#5e-dying", "stroke": "#f00", "stroke-width": 2}), dyingCircle]),
