...
import {createSVG, circle, defs, ellipse, feColorMatrix, filter, g, line, mask, path, pattern, polygon, rect, symbol, svg, text, use} from '../lib/svg.js';
...
addSymbol("5e-condition-BLESSED", symbol({"viewBox": "0 0 11 10.5"}, [ellipse({"cx": 5.5, "cy": 2, "rx": 5, "ry": 1.5, "fill": "transparent", "stroke": "#ff0", "stroke-width": 1}), circle({"cx": 5.5, "cy": 5.5, "r": 5, "fill": "#fc8"}), ellipse({"cx": 5.5, "cy": 2, "rx": 5, "ry": 1.5, "fill": "transparent", "stroke": "#ff0", "stroke-width": 1, "stroke-dasharray": 10}), path({"d": "M2,5.5 q1,-1 2,0 m2.5,0 q1,-1 2,0 M3.5,8.5 q2,1 4,0", "fill": "transparent", "stroke": "#000", "stroke-width": 0.1, "stroke-linecap": "round"})]));
...
addSymbol("5e-condition-DYING", symbol({"viewBox": "0 0 6.2 9.3"}, path({"d": "M3.1,0.2 q-6,8 0,9 q6,-1 0,-9 Z", "stroke": "#000", "stroke-width": 0.2, "fill": "#a00"})));
addSymbol("5e-condition-EXHAUSTED", symbol({"viewBox": "0 0 82 97"}, g({"stroke": "#000", "fill": "#fff", "stroke-width": 1}, [circle({"cx": 41, "cy": 41, "r": 40, "fill": "#fea"}), circle({"cx": 41, "cy": 60, "r": 6, "fill": "#000"}), path({"d": "M11,30 a2,1 0,0,0 20,0 m20,0 a2,1 0,0,0 20,0", "fill": "none"}), path({"d": "M37,60 l-5,18 l1,11 h16 l1,-11 l-5,-18 z"}), path({"d": "M36,80 a8,8 0,1,0 -3,10 M46,80 a8,8 0,1,1 3,10 M33,88 a8,8 0,1,0 16,0"})])));
