...
addSymbol("5e-condition-BLUR", symbol({"viewBox": "0 0 140 90"}, [defs(g({"id": "blur-face-5e"}, [circle({"cx": 50, "cy": 50, "r": 48, "fill": "#fc8"}), path({"d": "M30,30 v10 a5,5 0,0,0 10,0 v-10 a5,5, 0,0,0 -10,0 M60,30 v10 a5,5 0,0,0 10,0 v-10 a5,5, 0,0,0 -10,0 M20,60 q30,20 60,0 q-30,40 -60,0 Z", "fill": "#321"})])), use({"href": "#blur-face-5e", "style": "opacity: 0.6"}), use({"href": "#blur-face-5e", "style": "opacity: 0.6", "transform": "translate(50, 0)"}), use({"href": "#blur-face-5e", "style": "opacity: 0.8", "transform": "translate(25, 0)"})]));
