...
import {createSVG, animate, animateMotion, circle, defs, ellipse, feColorMatrix, filter, g, line, linearGradient, mask, mpath, path, pattern, polygon, rect, stop, symbol, svg, text, use} from '../lib/svg.js';
