...
addSymbol("5e-condition-CONFUSED", symbol({"viewBox": "0 0 6 10"}, text({"y": 9.5, "font-size": 14, "fill": "#fff", "stroke": "#000", "stroke-width": 0.25}, "?"))); 
...
addSymbol("5e-condition-INSPIRED", symbol({"viewBox": "0 0 6 10"}, text({"x": 0.5, "y": 9.5, "font-size": 14, "fill": "#fff", "stroke": "#000", "stroke-width": 0.25}, "!"))); 
...
addSymbol("5e-condition-UNCONSCIOUS", symbol({"viewBox": "0 0 8 10"}, g({"stroke": "#000", "stroke-width": 0.075, "fill": "#fff"}, [text({"x": 0.5, "y": 9.5, "font-size": 2}, "Z"), text({"x": 1.5, "y": 8, "font-size": 3}, "Z"), text({"x": 3, "y": 6.5, "font-size": 4}, "Z"), text({"x": 5, "y": 3.5, "font-size": 5}, "Z")])));
