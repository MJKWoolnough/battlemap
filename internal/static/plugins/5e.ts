...
addSymbol("5e-condition-BLESSED", symbol({"viewBox": "0 0 11 11"}, [circle({"cx": 5, "cy": 6, "r": 5, "fill": "#fc8"}), ellipse({"cx": 5, "cy": 2.5, "rx": 5, "ry": 2, "fill": "transparent", "stroke": "#ff0", "stroke-width": 1}), path({"d": "M1.5,6 q1,-1 2,0 m2.5,0 q1,-1 2,0 M3,9 q2,1 4,0", "fill": "transparent", "stroke": "#000", "stroke-width": 0.1, "stroke-linecap": "round"})]));
